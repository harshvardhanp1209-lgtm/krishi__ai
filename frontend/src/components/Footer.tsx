      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 grid gap-10 md:grid-cols-3">
        <div>
          ...
          <p className="mt-3 text-sm text-muted-foreground max-w-xs">
            AI-powered smart farming assistant helping farmers grow better, smarter, and more
            profitably.
          </p>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
              <Link to="/recommend" className="hover:text-primary">
                Crop Recommendation
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <div className="flex gap-3">
            <a
              className="h-9 w-9 rounded-full bg-card border border-border flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors"
              href="#"
            >
