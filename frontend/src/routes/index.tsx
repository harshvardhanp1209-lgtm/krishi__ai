...
const features = [
  {
    ...
    description: "Best crop choices based on your soil nutrients, climate and location.",
    accent: "primary" as const,
  },
  {
    icon: FlaskConical,
    title: "Soil Health Analysis",
    description: "Understand your soil's nutrient balance and improve fertility.",
    accent: "earth" as const,
  },
  {
    icon: Beaker,
    title: "Fertilizer Advice",
    description: "Personalized NPK and organic fertilizer suggestions.",
    accent: "harvest" as const,
  },
  {
    icon: CloudSun,
    title: "Weather Alert",
    description: "Stay ahead of rain, heatwaves and unexpected weather events.",
    accent: "primary" as const,
  },
  {
    icon: Bug,
    title: "Disease Risk Prediction",
    description: "Early warnings for pests and crop diseases before they spread.",
    accent: "earth" as const,
  },
  {
    icon: TrendingUp,
    title: "Profitability Insights",
    description: "Estimate yield value and choose the most profitable crop.",
    accent: "harvest" as const,
  },
  {
    icon: MessageCircle,
    title: "AI Chatbot",
    description: "Ask anything in English or Hindi — your 24/7 farming assistant.",
    accent: "primary" as const,
  },
];
    ...
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-28 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="mt-5 text-lg sm:text-xl text-muted-foreground max-w-xl">
              Smart Crop Recommendation and Farming Assistant — grow better with data, weather, and
              intelligent insights tuned for your land.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                to="/recommend"
                className="group inline-flex items-center gap-2 rounded-full bg-gradient-hero px-6 py-3 text-sm font-semibold text-primary-foreground shadow-soft hover:shadow-glow hover:-translate-y-0.5 transition-all"
              >
                Get Recommendation{" "}
            ...
            <div className="mt-10 flex flex-wrap gap-6 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                <Leaf className="h-4 w-4 text-primary" /> 50+ crops
              </div>
              <div className="flex items-center gap-2">
                <CloudSun className="h-4 w-4 text-harvest" /> Live weather
              </div>
              <div className="flex items-center gap-2">
                <MessageCircle className="h-4 w-4 text-earth" /> Hindi + English
              </div>
            </div>
          </motion.div>
            ...
            <div className="rounded-3xl bg-gradient-card border border-border p-6 shadow-glow">
              <div className="rounded-2xl bg-card p-6 border border-border">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  High N levels, stable rainfall and ideal pH detected.
                </p>
      ...
      <section id="features" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="mt-3 text-muted-foreground">
            From sowing to harvest — Krishi AI guides every step with data-driven recommendations.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-20">
        <div className="rounded-3xl bg-gradient-hero p-10 sm:p-14 text-center shadow-glow">
          <h3 className="text-3xl sm:text-4xl font-bold text-primary-foreground">
            Ready to grow smarter?
          </h3>
          <p className="mt-3 text-primary-foreground/90 max-w-xl mx-auto">
            Enter your soil and weather data and get a personalized crop recommendation in seconds.
          </p>
          <Link
            to="/recommend"
            className="mt-7 inline-flex items-center gap-2 rounded-full bg-card px-6 py-3 text-sm font-semibold text-primary hover:-translate-y-0.5 transition-transform shadow-soft"
          >
