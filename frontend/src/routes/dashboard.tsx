  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
      ...
      >
        ...
        <Link
          to="/recommend"
          className="inline-flex items-center gap-2 rounded-full bg-gradient-hero px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-soft hover:shadow-glow hover:-translate-y-0.5 transition-all"
        >
      ...
      <div className="mt-10 grid lg:grid-cols-3 gap-5">
        <motion.div
          ...
          viewport={{ once: true }}
          className="lg:col-span-2 rounded-3xl bg-card border border-border p-6 shadow-soft"
        >
          <h3 className="text-lg font-semibold">Seasonal Outlook</h3>
          <p className="mt-1 text-sm text-muted-foreground">
            Trends from the past 6 months for your region.
          </p>
